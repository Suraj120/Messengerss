...
class ChatLogControllers: UIViewController, UICollectionViewDelegateFlowLayout, NSFetchedResultsControllerDelegate,UICollectionViewDelegate,UICollectionViewDataSource {
...
//                    let indexPath = IndexPath(item: lastItemIndex, section: 0)
                    self.collectionView?.scrollToItem(at: IndexPath(item: lastItemIndex, section: 0), at: .top , animated: true)
     ...
     func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let messageText = message.text, let profileImageName = message.friend?.profileImageName {
            ...
            if !message.isSender {
                ...
                cell.textBubbleView?.frame = CGRect(x:view.frame.width - estimatedFrame.width - 2, y: 0.0, width: estimatedFrame.width, height: estimatedFrame.height + 0 )
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if let messageText = message.text {
           ...
           return CGSize(width: view.frame.width , height: estimatedFrame.height+7)
